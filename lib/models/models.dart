...
//OK
  ...
  Models({
     ...
     [this._height,
      ...
      this._on_the_day,
      this._date,
      this._priority]); //定期・ドッグフラグ





  Models.withId(this._id, this._date, this._priority,[this._height, this._weight, this._waist,
  ...
  Models.fromMapObject(Map<String, dynamic> map) {
    this._id = map['id'];
